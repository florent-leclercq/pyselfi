#!/usr/bin/env python
#-------------------------------------------------------------------------------------
# pySELFI v1.0 -- examples/simbelmyne/model/setup_SBMY.py
...
from .blackbox_SBMY import blackbox
...
fname_inputsskgrid="input_ss_k_grid.h5"
P=50
k_ss_min=2.0e-2
k_ss_max=0.5
...
save_frequency=1
blackbox=blackbox(P,theta2P=theta2P,k_s=k_s,G_sim=G_sim,G_ss=G_ss,P_ss=P_ss,corner0=corner0,corner1=corner1,corner2=corner2,Np0=Np0,Npm0=Npm0,fdir=fdir,fsimdir=fdir,fname_inputsurveygeometry=fname_inputsurveygeometry,fname_inputsskgrid=fname_inputsskgrid,b_cut=b_cut,bright_apparent_magnitude_cut=bright_apparent_magnitude_cut,faint_apparent_magnitude_cut=faint_apparent_magnitude_cut,bright_absolute_magnitude_cut=bright_absolute_magnitude_cut,faint_absolute_magnitude_cut=faint_absolute_magnitude_cut,Mstar=Mstar,alpha=alpha,save_frequency=save_frequency)

# Survey geometry and summaries k-grid
